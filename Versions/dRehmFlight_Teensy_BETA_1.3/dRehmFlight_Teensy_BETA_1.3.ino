...
float maxRoll = 30.0;     //Max roll angle in degrees for angle mode (default 30, maximum ~70 degrees), deg/sec for rate mode 
float maxPitch = 30.0;    //Max pitch angle in degrees for angle mode (defautl 30, maximum ~70 degrees), deg/sec for rate mode
